...
abstract class GuavaSmoothRateLimiter extends GuavaRateLimiter {
  /*
   ...
   * </ul>
   */
  static final class SmoothWarmingUp extends GuavaSmoothRateLimiter {
   ...
   */
  static final class SmoothBursty extends GuavaSmoothRateLimiter {
  ...
  private GuavaSmoothRateLimiter(SleepingStopwatch stopwatch) {
    super(stopwatch);
  }
  ...
  final long reserveEarliestAvailable(int requiredPermits, long nowMicros) {
    ...
    this.nextFreeTicketMicros = GuavaLongMath.saturatedAdd(nextFreeTicketMicros, waitMicros);
