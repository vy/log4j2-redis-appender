...
/**
 * Constants of {@code log4j2.RedisAppenderReconnectTest.xml} configuration file.
 */
enum RedisAppenderReconnectTestConfig {;
    ...
    static final URI LOG4J2_CONFIG_FILE_URI = URI.create("classpath:log4j2.RedisAppenderReconnectTest.xml");

    static final String LOG4J2_APPENDER_NAME = "REDIS";

    static final int BATCH_SIZE = 1;

    static final int FLUSH_PERIOD_MILLIS = 60_000;
