...
/**
 * Constants of {@code log4j2.RedisAppenderShutdownTest.xml} configuration file.
 */
enum RedisAppenderShutdownTestConfig {;
    ...
    static final URI LOG4J2_CONFIG_FILE_URI = URI.create("classpath:log4j2.RedisAppenderShutdownTest.xml");
